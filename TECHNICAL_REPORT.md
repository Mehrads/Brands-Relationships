...
- **Citation Extractor**: LLM-powered citation extraction and URL association using intelligent semantic reasoning. This approach leverages Tree of Thoughts prompting to identify both explicit URLs and implicit citations through contextual understanding of the text. The system intelligently associates extracted URLs with relevant text passages, providing proper attribution and evidence trails for relationship classifications while maintaining high accuracy through semantic analysis.
